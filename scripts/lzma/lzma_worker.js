...
var LZMA = (function () {
    ...
    function $ReadBlock(this$static) {
        ...
        while (1) {
            ...
            if (numReadBytes == -1) {
                ...
                pointerToPostion =
                    this$static._bufferOffset + this$static._posLimit;
                if (pointerToPostion > this$static._pointerToLastSafePosition) {
    ...
    function $GetMatches(this$static, distances) {
        ...
        if (this$static.HASH_ARRAY) {
            ...
            hashValue =
                (temp ^
                    (CrcTable[this$static._bufferBase[cur + 3] & 255] << 5)) &
        ...
        if (this$static.HASH_ARRAY) {
            ...
            if (curMatch2 > matchMinPos) {
                if (
                    this$static._bufferBase[
                        this$static._bufferOffset + curMatch2
            ...
            if (curMatch3 > matchMinPos) {
                if (
                    this$static._bufferBase[
                        this$static._bufferOffset + curMatch3
                    ] == this$static._bufferBase[cur]
                ) {
        ...
        if (this$static.kNumHashDirectBytes != 0) {
            if (curMatch > matchMinPos) {
                if (
                    ...
                    this$static._bufferBase[
                        cur + this$static.kNumHashDirectBytes
                    ]
                ) {
            ...
            if (
                ...
                if (maxLen < len) {
                    ...
                    if (len == lenLimit) {
                        ...
                        this$static._son[ptr0] =
                            this$static._son[cyclicPos + 1];
                        break;
                    }
                }
            }
    ...
    function $Skip(this$static, num) {
        ...
        do {
            ...
            if (this$static.HASH_ARRAY) {
                ...
                hashValue =
                    (temp ^
                        (CrcTable[this$static._bufferBase[cur + 3] & 255] <<
                            5)) &
                    this$static._hashMask;
            } else {
                hashValue =
    ...
    function $CopyBlock(this$static, distance, len) {
        ...
        for (; len != 0; --len) {
            ...
            this$static._buffer[this$static._pos++] =
                this$static._buffer[pos++];
    ...
    function $Create(this$static, numPosStates) {
        for (
            ...
            this$static.m_LowCoder[this$static.m_NumPosStates] =
                $BitTreeDecoder({}, 3);
            this$static.m_MidCoder[this$static.m_NumPosStates] =
                $BitTreeDecoder({}, 3);
        }
    }
    ...
    function $CodeOneBlock(this$static, inSize, outSize, finished) {
        ...
        if (eq(this$static.nowPos64, P0_longLit)) {
            ...
            posState =
                lowBits_0(this$static.nowPos64) & this$static._posStateMask;
            $Encode_3(
    ...
    function $FillDistancesPrices(this$static) {
        ...
        for (lenToPosState = 0; lenToPosState < 4; ++lenToPosState) {
            ...
            for (
                posSlot = 14;
                posSlot < this$static._distTableSize;
                ++posSlot
            ) {
    ...
    function $GetOptimum(this$static, position) {
        ...
        while (1) {
            ...
            if (this$static._optimum[cur].Prev1IsChar) {
                ...
                if (this$static._optimum[cur].Prev2) {
                    state =
                        this$static._optimum[this$static._optimum[cur].PosPrev2]
                            .State;
            ...
            curAnd1Price =
                curPrice +
                ProbPrices[
                    this$static._isMatch[(state << 4) + posState] >>> 2
                ] +
                $GetPrice_0(
                    $GetSubCoder(
                        this$static._literalEncoder,
            ...
            if (
                ...
                shortRepPrice =
                    ...
                    (ProbPrices[this$static._isRepG0[state] >>> 2] +
                        ProbPrices[
                            this$static._isRep0Long[(state << 4) + posState] >>>
                                2
                        ]);
                        ...
                        if (lenTest < numAvailableBytesFull) {
                            ...
                            if (lenTest2 >= 2) {
                                ...
                                nextRepMatchPrice =
                                    nextMatchPrice +
                                    ProbPrices[
                                        (2048 - this$static._isRep[state2]) >>>
                                            2
                                    ];
                                offset = lenTest + 1 + lenTest2;
                                while (lenEnd < cur + offset) {
                                    this$static._optimum[++lenEnd].Price =
                                        268435455;
                                }
                                curAndLenPrice =
                                    nextRepMatchPrice +
    ...
    function $GetPosLenPrice(this$static, pos, len, posState) {
        ...
        if (pos < 128) {
            ...
            price =
                this$static._posSlotPrices[
                    (lenToPosState << 6) + GetPosSlot2(pos)
    ...
    function $ReadMatchDistances(this$static) {
        ...
        if (this$static._numDistancePairs > 0) {
            lenRes =
                this$static._matchDistances[this$static._numDistancePairs - 2];
            if (lenRes == this$static._numFastBytes)
                lenRes += $GetMatchLen(
                    this$static._matchFinder,
                    lenRes - 1,
                    this$static._matchDistances[
                        this$static._numDistancePairs - 1
                    ],
                    273 - lenRes,
                );
        }
    ...
    function $Encode(this$static, rangeEncoder, symbol, posState) {
        if (symbol < 8) {
            ...
            if (symbol < 8) {
                ...
                $Encode_2(
                    this$static._midCoder[posState],
                    rangeEncoder,
                    symbol,
                );
            } else {
    ...
    function $SetPrices(this$static, posState, numSymbols, prices, st) {
        ...
        for (i = 0; i < 8; ++i) {
            ...
            prices[st + i] =
                a0 + $GetPrice_1(this$static._lowCoder[posState], i);
        }
        for (; i < 16; ++i) {
            if (i >= numSymbols) return;
            prices[st + i] =
        ...
        for (; i < numSymbols; ++i) {
            prices[st + i] =
                b1 + $GetPrice_1(this$static._highCoder, i - 8 - 8);
        }
    }
    ...
    function $Init_3(this$static) {
        var i,
            numStates =
                1 << (this$static.m_NumPrevBits + this$static.m_NumPosBits);
        for (i = 0; i < numStates; ++i) {
    ...
    function ReverseGetPrice(Models, startIndex, NumBitLevels, symbol) {
        ...
        for (i = NumBitLevels; i != 0; --i) {
            ...
            price +=
                ProbPrices[
                    (((Models[startIndex + m] - bit) ^ -bit) & 2047) >>> 2
                ];
            m = (m << 1) | bit;
        }
        return price;
    ...
    function $DecodeBit(this$static, probs, index) {
        ...
        if ((this$static.Code ^ -2147483648) < (newBound ^ -2147483648)) {
            ...
            if (!(this$static.Range & -16777216)) {
                this$static.Code =
                    (this$static.Code << 8) | $read(this$static.Stream);
                this$static.Range <<= 8;
            }
            return 0;
        } else {
                ...
                while ($processChunk(this$static.d.chunker)) {
                    if (++i % 1000 == 0 && new Date().getTime() - start > 200) {
                        if (has_progress) {
                            percent =
                                toDouble(
                                    this$static.d.chunker.decoder.nowPos64,
                                ) / len;
                            /// If about 200 miliseconds have passed, update the progress.
                            on_progress(percent);
                        }
